...
\begin{itemize}
    ...
    \item Kết luận tiêu chí 2: Để đơn giản hóa kiến trúc và giảm tải cho Backend, mô hình được chọn bắt buộc phải hỗ trợ Native Video Input (cho phép gửi trực tiếp file video qua API để mô hình tự xử lý nội bộ). Điều này giúp quy trình kiểm duyệt chỉ còn là 1 API call duy nhất.
\end{itemize}
