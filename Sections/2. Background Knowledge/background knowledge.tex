...
\begin{itemize}
    \item Vận chuyển: Bao gồm hàng không, đường sắt, đường bộ (xe buýt, ô tô cá nhân, xe cho thuê), và đường thủy (tàu du lịch, phà). Đây là yếu tố nền tảng cho sự di chuyển của du khách.
    \item Lưu trú: Gồm khách sạn, khu nghỉ dưỡng (resorts), nhà nghỉ, căn hộ dịch vụ, homestay, và các nền tảng chia sẻ như Airbnb. Đây là nơi du khách ở lại trong suốt chuyến đi.
    \item Điểm tham quan và hoạt động: Bao gồm các tài nguyên thiên nhiên (bãi biển, công viên quốc gia), di sản văn hóa (bảo tàng, di tích lịch sử), công trình nhân tạo (công viên giải trí, trung tâm mua sắm), và các hoạt động trải nghiệm (lớp học nấu ăn, tour đi bộ, thể thao mạo hiểm).
    \item Dịch vụ ăn uống: Nhà hàng, quán cà phê, quán bar, dịch vụ ăn uống tại nơi lưu trú.
    \item Dịch vụ lữ hành: Các đơn vị trung gian kết nối du khách với các nhà cung cấp dịch vụ, bao gồm đại lý du lịch, công ty tổ chức tour, và các nền tảng trực tuyến.
\end{itemize}
...
\begin{enumerate}
    \item Giai đoạn ước mơ (Dreaming): Đây là điểm khởi đầu khi người dùng nảy sinh ý định du lịch thông qua việc quan sát trải nghiệm của bạn bè, đồng nghiệp trên các mạng xã hội như Facebook, Instagram hoặc Twitter.
    \item Giai đoạn lập kế hoạch (Planning): Người dùng chuyển sang nghiên cứu chi tiết về điểm đến. Giai đoạn này thường được thực hiện thông qua các nền tảng đánh giá như TripAdvisor hoặc các nguồn thông tin mở như Wikipedia để tối ưu hóa lịch trình.
    \item Giai đoạn đặt dịch vụ (Booking): Sau khi đã có kế hoạch, du khách tiến hành đặt vé máy bay, phòng khách sạn hoặc các dịch vụ đi kèm. Sự tiện lợi và minh bạch của các nền tảng trực tuyến là yếu tố then chốt ở bước này.
    \item Giai đoạn trải nghiệm (Experiencing): Trong suốt chuyến đi, du khách liên tục sử dụng điện thoại thông minh để quản lý trải nghiệm cá nhân, từ việc tìm đường đến tìm kiếm các nội dung liên quan trực tiếp tại địa điểm thực tế.
    \item Giai đoạn chia sẻ (Sharing): Du khách chia sẻ hình ảnh, video và cảm nhận của mình lên không gian mạng. Hành động này đóng đóng vai trò quan trọng vì nó trở thành nguồn cảm hứng cho giai đoạn "Dreaming"\ của những người dùng khác trong tương lai.
\end{enumerate}
...
\begin{itemize}
    \item Giới hạn của LLM truyền thống: Các mô hình LLM sở hữu khả năng hiểu và sinh ngôn ngữ tự nhiên vượt trội. Tuy nhiên, kiến thức của chúng bị giới hạn trong bộ nhớ tham số (các trọng số tĩnh sau huấn luyện). Điều này dẫn đến việc mô hình không nắm bắt được dữ liệu cục bộ, dữ liệu thời gian thực và thường gây ra hiện tượng ảo giác (hallucination) – sinh ra thông tin sai lệch nhưng trình bày một cách tự tin.
    \item Nguyên lý RAG: Kiến trúc RAG ra đời nhằm cung cấp một bộ nhớ ngoài tinh gọn, có thể truy xuất linh hoạt dựa trên không gian vector \cite{lewis-2020, gao-2023}. RAG đóng vai trò như một lớp bộ nhớ đệm thông minh, giúp LLM tập trung vào nhiệm vụ suy luận và định dạng kết quả thay vì gánh vác việc ghi nhớ thông tin rời rạc. Toàn bộ quá trình hoạt động gồm hai giai đoạn chính:
    \begin{itemize}
        \item Giai đoạn truy xuất (Retrieval): Dựa trên độ tương đồng vector, hệ thống tìm kiếm trong cơ sở dữ liệu bên ngoài để lấy ra các đoạn thông tin, dữ liệu địa điểm (POI) liên quan sát nhất với truy vấn của người dùng.
        \item Giai đoạn sinh văn bản (Generation): Các tập dữ liệu vừa được truy xuất sẽ được tiêm vào ngữ cảnh của LLM. Mô hình sẽ dựa trên nền tảng dữ liệu thực tế này để tổng hợp, sắp xếp và sinh ra câu trả lời hoặc kịch bản hành trình cuối cùng, đảm bảo tính chính xác và không bịa đặt thông tin.
    \end{itemize}
\end{itemize}
