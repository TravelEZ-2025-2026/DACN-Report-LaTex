...
\begin{itemize}
    \item Category \& Entity (Phân loại \& thực thể): Định danh rõ loại hình (Ví dụ: nhà hàng, quán cafe, điểm tham quan).
    \item Vibe (Không khí): Các đặc tính như yên tĩnh, lãng mạn, nhộn nhịp, v.v.
    \item Scenario (Ngữ cảnh sử dụng): Các tình huống như hẹn hò, làm việc, họp mặt gia đình, v.v.
    \item Audience (Đối tượng phù hợp): Sinh viên, cặp đôi, gia đình có trẻ nhỏ, v.v.
    \item Highlights \& Amenities (Điểm nổi bật \& tiện ích): Bãi đỗ xe, nhạc sống, tầm nhìn hoàng hôn, v.v.
\end{itemize}
...
\begin{itemize}
    \item Khớp nối ý định: Khi người dùng nhập yêu cầu dạng tự do (ví dụ: "địa điểm lãng mạn cho hai người"), hệ thống truy vấn trực tiếp vào không gian vector để lấy các POI có Audience tương ứng với "couple" và Vibe tương ứng với "romantic".
    \item Cập nhật thích nghi theo thời gian: Khi người dùng tương tác nhiều với các địa điểm có đặc trưng nhất định, vector sở thích của họ dịch chuyển dần về phía cụm vector của các địa điểm đó. Ở giai đoạn sinh lịch trình, hệ thống sẽ lấy các POI nằm gần vector người dùng nhất làm ngữ cảnh đầu vào, nhờ đó kết quả đầu ra tự động phù hợp với gu cá nhân mà không yêu cầu khai báo lại từ đầu.
\end{itemize}