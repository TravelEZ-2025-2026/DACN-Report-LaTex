...
\textbf{Luồng sự kiện chính} & 
\begin{tabular}[t]{@{}p{10.5cm}@{}}
1. Người dùng chọn biểu tượng “Lưu” tại bài viết hoặc địa điểm.\\
2. Hệ thống hiển thị danh sách “Bộ sưu tập” của người dùng.\\
3. Người dùng tuỳ chọn “Bộ sưu tập” để lưu bài viết/ địa điểm.\\
...
\textbf{Luồng thay thế} &
\begin{tabular}[t]{@{}p{10.5cm}@{}}
3(a)1.  Người dùng chọn biểu tượng “+” để tạo “Bộ sưu tập”.  
...
3. Người dùng chọn xem “tất cả bài viết” hoặc “bộ sưu tập” cụ thể.\\
...
\textbf{Luồng sự kiện chính} & 
\begin{tabular}[t]{@{}p{10.5cm}@{}}
1. Người dùng chọn nút “Theo dõi” chủ đề hoặc địa điểm. \\
