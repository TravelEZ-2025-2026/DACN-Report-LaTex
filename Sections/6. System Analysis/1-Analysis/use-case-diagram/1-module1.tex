...
\textbf{Mô tả}             & Traveler nhập các thông tin mong muốn cho chuyến đi (địa điểm, thời gian, ngân sách, sở thích...). Hệ thống AI tiếp nhận, phân tích và tự động tạo ra một bản lộ trình du lịch chi tiết phù hợp nhất. \\ \midrule
\textbf{Tiền điều kiện}    & Traveler đã đăng nhập và đang ở màn hình "Tạo lộ trình" \space (Dashboard hoặc Home). \\ \midrule
\textbf{Hậu điều kiện}     & Một bản nháp lộ trình hoàn chỉnh được hiển thị trên màn hình, bao gồm danh sách địa điểm và thời gian cụ thể.\\ \midrule
...
- Tên chuyến đi mới (Mặc định là "Copy of [Tên cũ]").\\
...
\textbf{Tên Use case}      & Đề xuất Dịch vụ \& Tour tham khảo \\ \midrule
\textbf{Các tác nhân}      & Traveler \\ \midrule
\textbf{Mô tả}             & Dựa trên địa điểm hoặc khu vực mà Traveler đang xem trong lộ trình, hệ thống phân tích và đề xuất các dịch vụ thương mại phù hợp (Tour trọn gói, vé tham quan, hoặc phương tiện di chuyển du lịch) giúp người dùng dễ dàng đặt chỗ. \\ \midrule
\textbf{Tiền điều kiện}    & Traveler đã đăng nhập vào hệ thống và đang xem một lộ trình chi tiết có chứa các địa điểm hoặc hoạt động cụ thể.\\ \midrule
\textbf{Hậu điều kiện}     & Hệ thống đề xuất các dịch vụ phù hợp với địa điểm \\ \midrule
\textbf{Luồng sự kiện chính} &
\begin{tabular}[t]{@{}p{10.5cm}@{}}
...
\textbf{Các tác nhân}      & Traveler \\ \midrule
\textbf{Mô tả}             & Traveler thực hiện tinh chỉnh lộ trình theo ý muốn cá nhân hoặc đưa ra yêu cầu để AI tái cấu trúc lại một phần hoặc toàn bộ lộ trình dựa trên ngữ cảnh mới.\\ \midrule
...
\end{tabular} \\ \midrule
\textbf{Hậu điều kiện}     & Lộ trình được cập nhật với thứ tự, thời gian và địa điểm mới hợp lý. Dữ liệu được lưu lại. \\ \midrule
\textbf{Luồng sự kiện chính} &
\begin{tabular}[t]{@{}p{10.5cm}@{}}
...
\textbf{Các tác nhân}      & Traveler \\ \midrule
\textbf{Mô tả}             & Lưu trạng thái hiện tại của lộ trình vào tài khoản cá nhân để truy cập sau.\\ \midrule
\textbf{Tiền điều kiện}    & Traveler đã đăng nhập và đang có một lộ trình trên màn hình. \\ \midrule
\textbf{Hậu điều kiện}     & Dữ liệu lộ trình được ghi vào CSDL. \\ \midrule
\textbf{Luồng sự kiện chính} &
\begin{tabular}[t]{@{}p{10.5cm}@{}}
...
\textbf{Các tác nhân}      & Traveler \\ \midrule
\textbf{Mô tả}             & Xóa vĩnh viễn một lộ trình đã lưu khỏi tài khoản. \\ \midrule
\textbf{Tiền điều kiện}    & Traveler đang ở màn hình danh sách lộ trình ("Chuyến đi của tôi"). \\ \midrule
\textbf{Hậu điều kiện}     & Lộ trình bị loại bỏ khỏi CSDL và không còn hiển thị trong danh sách. \\ \midrule
\textbf{Luồng sự kiện chính} &
\begin{tabular}[t]{@{}p{10.5cm}@{}}
