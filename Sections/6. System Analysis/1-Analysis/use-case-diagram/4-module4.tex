...
\textbf{Các tác nhân}      & Traveler \\ \midrule
\textbf{Mô tả}             & Cho phép Traveler tạo đánh giá mới, chỉnh sửa hoặc xóa đánh giá của chính mình đối với một địa điểm. Hệ thống hỗ trợ xử lý hình ảnh tối ưu trước khi lưu. \\ \midrule
...
\end{tabular} \\ \midrule
\textbf{Hậu điều kiện}     & Review được cập nhật vào CSDL; điểm đánh giá trung bình của địa điểm được tính toán lại. \\ \midrule
\textbf{Luồng sự kiện chính} & 
\begin{tabular}[t]{@{}p{10.5cm}@{}}
...
\begin{tabular}[t]{@{}p{10.5cm}@{}}
\textbf{E1: Lỗi Media}\\
Tại bước 5, nếu file bị lỗi định dạng hoặc quá lớn không thể nén, hệ thống báo: "file không hợp lệ, vui lòng chọn file khác" \space và giữ nguyên nội dung text đã nhập.
\end{tabular} \\ 
\bottomrule
\end{longtable}
...
\end{tabular} \\ \midrule
\textbf{Hậu điều kiện}     & Một bài viết mới được tạo, một bài viết cũ được cập nhật hoặc xóa khỏi hệ thống. \\ \midrule
\textbf{Luồng sự kiện chính} & 
\begin{tabular}[t]{@{}p{10.5cm}@{}}
...
\textbf{Các tác nhân}      & Traveler \\ \midrule
\textbf{Mô tả}             & Cho phép Traveler tương tác với một bài viết hoặc review thông qua các hành động: để lại bình luận, bày tỏ cảm xúc, hoặc lưu lại bài viết. \\ \midrule
\textbf{Tiền điều kiện}    & 
\begin{tabular}[t]{@{}p{10.5cm}@{}}
1. Traveler đã đăng nhập vào hệ thống.\\
2. Traveler đang ở trang xem chi tiết một bài viết.
\end{tabular} \\ \midrule
\textbf{Hậu điều kiện}     & Tương tác của Traveler được ghi nhận vào hệ thống và giao diện được cập nhật để phản ánh sự thay đổi đó. \\ \midrule
\textbf{Luồng sự kiện chính} & 
\begin{tabular}[t]{@{}p{10.5cm}@{}}
...
\textbf{Các tác nhân}      & Traveler \\ \midrule
\textbf{Mô tả}             & Cho phép Traveler tạo một nhóm chat mới bằng cách chọn các thành viên từ danh sách bạn bè của mình. \\ \midrule
\textbf{Tiền điều kiện}    & 
\begin{tabular}[t]{@{}p{10.5cm}@{}}
...
\textbf{Các tác nhân}      & Traveler \\ \midrule
\textbf{Mô tả}             & Cho phép một Traveler gửi một tin nhắn riêng tư cho một Traveler khác trong hệ thống. Use case này bao gồm việc xem lại lịch sử trò chuyện và gửi tin nhắn mới. \\ \midrule
\textbf{Tiền điều kiện}    & 
\begin{tabular}[t]{@{}p{10.5cm}@{}}
1. Traveler đã đăng nhập vào hệ thống.\\
...
\textbf{Các tác nhân}      & Traveler \\ \midrule
\textbf{Mô tả}             & Cho phép Traveler gửi một báo cáo về một nội dung (bài viết, review, bình luận) mà họ cho là vi phạm tiêu chuẩn cộng đồng. Báo cáo này sẽ được gửi đến đội ngũ quản trị viên để xem xét và xử lý. \\ \midrule
\textbf{Tiền điều kiện}    & 
\begin{tabular}[t]{@{}p{10.5cm}@{}}
1. Traveler đã đăng nhập vào hệ thống.\\
