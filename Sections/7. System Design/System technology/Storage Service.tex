...
\subsubsection{Dịch vụ Lưu trữ File}

\paragraph{Amazon S3}

\subparagraph{Giới thiệu}
Amazon S3 (Simple Storage Service) là một dịch vụ lưu trữ đối tượng (object storage) của AWS, được thiết kế để lưu trữ và truy xuất lượng lớn dữ liệu một cách an toàn và hiệu quả. Trong hệ thống TrailTrust, S3 được sử dụng chuyên biệt cho việc lưu trữ các file media \textbf{(hình ảnh, video)} mà người dùng tải lên khi viết review hoặc đăng bài blog. Việc tách biệt lưu trữ file ra khỏi máy chủ ứng dụng giúp giảm tải cho backend và dễ dàng mở rộng dung lượng lưu trữ trong tương lai.
