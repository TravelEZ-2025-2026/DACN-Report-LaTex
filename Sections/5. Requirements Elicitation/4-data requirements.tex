...
Hệ thống lưu trữ thông tin các Thành phố (CITY), mỗi thành phố có các Địa điểm du lịch (PLACE\_OF\_INTERESTS). Các POI ở thành phố có thể là địa điểm tham quan (ATTRACTION), ăn uống (RESTAURANT), lưu trú (HOTEL) tại thành phố đó. Hệ thống lưu trữ danh sách các nhà cung cấp dịch vụ (OPERATOR) tương ứng với các POI. POI có thể có một nhà cung cấp dịch vụ và các nhà cung cấp dịch vụ có thể cung cấp nhiều POI.
