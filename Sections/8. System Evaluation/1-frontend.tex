...
Trong giai đoạn đầu tiên của đồ án, nhóm đã hoàn thành việc xây dựng giao diện người dùng (Frontend) cho các chức năng cơ bản của hệ thống. Giao diện được thiết kế với mục tiêu thân thiện, dễ sử dụng và tương thích trên nhiều thiết bị khác nhau. 
