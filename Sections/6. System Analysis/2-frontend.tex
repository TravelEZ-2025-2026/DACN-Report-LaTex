...
\hline
\end{tabularx}
\caption{So sánh Next.js và các công nghệ Frontend khác \cite{waqar2021, shah2023}}
\end{table}
\end{landscape}
...
\hline
\end{tabularx}
\caption{So sánh ShadCN/UI với các thư viện UI truyền thống \cite{ui_comparison_2025, kitemetric2025}}
\end{table}
\end{landscape}
