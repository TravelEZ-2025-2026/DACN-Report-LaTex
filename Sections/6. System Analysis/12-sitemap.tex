...
\begin{figure}[H]
    ...
    \caption{Các trang của hệ thống TravelEZ}
    \label{fig:sitemap}
\end{figure}
...
\end{tabular}
\caption{Các trang dành cho tất cả người dùng}
\label{tab:all-user}
\end{table}
...
AI Assist for Itineraries & Gửi hành trình và nhận phân tích về đề xuất cải thiện từ AI.                      \\ \hline
\end{tabular}
\caption{Các trang dành cho Nhà cung cấp (Provider)}
\label{tab:provider}
\end{table}
...
\end{tabular}
\caption{Các trang dành cho Khách du lịch (Travelers) và người dùng đã xác thực.}
\label{tab:travelers}
\end{table}
...
\end{tabular}
\caption{Các trang dành cho Quản trị viên hệ thống (Admin)}
\label{tab:admin}
\end{table}
