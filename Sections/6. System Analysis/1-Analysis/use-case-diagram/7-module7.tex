...
\textbf{Mô tả}             & Provider cung cấp lịch trình hiện tại và các tiêu chí mong muốn. Hệ thống AI phân tích, chỉ ra điểm yếu và tự động tái cấu trúc để tạo ra một phiên bản lịch trình mới tối ưu hơn.\\ \midrule
...
3. Hệ thống hiển thị form nhập liệu, cho phép chọn nguồn dữ liệu:\\
- Option A: Chọn một Tour/Lịch trình có sẵn trong kho dữ liệu của Provider.\\
- Option B: Copy-paste văn bản lịch trình thô.\\
