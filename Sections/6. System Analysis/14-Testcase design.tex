...
Các kịch bản kiểm thử được xây dựng nhằm bao phủ toàn bộ các luồng nghiệp vụ từ cơ bản đến nâng cao. Chi tiết về các bước thực hiện, dữ liệu đầu vào và kết quả mong đợi được trình bày cụ thể tại các phụ lục bên dưới:
\begin{itemize}
    \item \hyperlink{target:tc_m1}{Danh sách Test Case chi tiết cho Module 1}
