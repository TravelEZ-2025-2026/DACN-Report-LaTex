...
Theo quy định tại Điều 3 Luật Du lịch 2017, các khái niệm về du lịch và hoạt động lữ hành được xác định rõ ràng nhằm tạo cơ sở cho cấu trúc ngành. Cụ thể, Du lịch được hiểu là các hoạt động liên quan đến chuyến đi của con người ngoài nơi cư trú thường xuyên nhằm mục đích tham quan, nghỉ dưỡng, giải trí hoặc kết hợp mục đích hợp pháp khác. Trong khi đó, Kinh doanh dịch vụ lữ hành đóng vai trò là hoạt động xây dựng, bán và tổ chức thực hiện các chương trình du lịch. \cite{luat-du-lich-2017}

Ngành du lịch hiện nay được cấu thành từ các lĩnh vực liên kết chặt chẽ sau:
\begin{itemize}
    \item \textbf{Vận chuyển (Transportation)}: Bao gồm hàng không, đường sắt, đường bộ và đường thủy. Đây là yếu tố nền tảng giúp kết nối du khách với các điểm đến.
    \item \textbf{Lưu trú (Accommodation)}: Gồm khách sạn, khu nghỉ dưỡng, homestay và các loại hình lưu trú khác. Đây là thành phần thiết yếu đảm bảo nhu cầu nghỉ ngơi của du khách trong suốt chuyến đi.
    \item \textbf{Điểm tham quan và hoạt động (Attractions \& Activities)}: Bao gồm tài nguyên thiên nhiên, di sản văn hóa và các công trình nhân tạo. Đây chính là yếu tố cốt lõi thu hút và tạo ra giá trị trải nghiệm cho du khách.
    \item \textbf{Dịch vụ ăn uống (Food \& Beverage)}: Hệ thống nhà hàng, quán cà phê và dịch vụ ẩm thực tại điểm đến, góp phần hoàn thiện chuỗi cung ứng dịch vụ du lịch.
    \item \textbf{Dịch vụ lữ hành (Travel Services)}: Các đơn vị trung gian như công ty lữ hành, đại lý du lịch và các nền tảng trực tuyến (OTA) đóng vai trò kết nối du khách với các nhà cung cấp dịch vụ đơn lẻ thành một chương trình du lịch hoàn chỉnh.
\end{itemize}
...
\subsection{Hành trình khách hàng trong du lịch}
