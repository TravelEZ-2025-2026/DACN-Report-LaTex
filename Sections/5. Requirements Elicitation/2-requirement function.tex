...
FR-1.4 & Người dùng chỉnh sửa lộ trình: thêm, xoá, sắp xếp lại hoạt động, điểm đến. & Traveler & Bắt buộc & Cao & Cao \\
...
\addlinespace
\multicolumn{6}{l}{\textbf{Module 4: Xây dựng cộng đồng \& nội dung}}\\[2pt]
...
FR-7.1 & Nhà cung cấp yêu cầu hệ thống tạo một lộ trình du lịch mẫu. AI sẽ phân tích dữ liệu xu hướng (ví dụ: địa điểm, dịch vụ đang phổ biến, sự kiện sắp diễn ra) để xây dựng và gợi ý một lịch trình cụ thể. Nhà cung cấp có thể xem xét, tham khảo lộ trình mẫu này. & Provider & Cần có & Trung bình & Trung bình \\
