...
\begin{itemize}
    ...
    \item Vibe (Không khí): Các đặc tính như yên tĩnh, lãng mạn, nhộn nhịp...
    \item Scenario (Ngữ cảnh sử dụng): Các tình huống như hẹn hò, làm việc, họp mặt gia đình...
    \item Audience (Đối tượng phù hợp): Sinh viên, cặp đôi, gia đình có trẻ nhỏ...
    \item Highlights \& Amenities (Điểm nổi bật \& tiện ích): Bãi đỗ xe, nhạc sống, tầm nhìn hoàng hôn...
\end{itemize}
